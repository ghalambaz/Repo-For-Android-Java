package com.yana.YFrame.CalendarUtils;/*
 * Ali Ghalambaz<aghalambaz@gmail.com> on 2015/10/10 - 13:10 .
 * Written in mahmood_motammam
...
public class SolarCalendar {
    ...
    public SolarCalendar(Long MiladiDate) {
        calcSolarCalendar(new Date(MiladiDate));
    }
    ...
    public static String getNow(String separator) {
